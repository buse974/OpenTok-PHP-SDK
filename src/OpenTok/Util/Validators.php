...
class Validators
{
    ...
    {
        if (isset($client) && !($client instanceof OpenTokClientInterface)) {
            throw new InvalidArgumentException(
                'The optional client was not an instance of \OpenTok\Util\ClientInterface. client:'.print_r($client, true)
            );
        }
    }
